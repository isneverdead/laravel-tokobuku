<?php namespace App\Http\Controllers;
	...
	class AdminPembelianController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Pembeli Id","name"=>"pembeli_id","join"=>"pembeli,nama"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Pembeli Id','name'=>'pembeli_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'pembeli,nama'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Pembeli Id","name"=>"pembeli_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"pembeli,nama"];
