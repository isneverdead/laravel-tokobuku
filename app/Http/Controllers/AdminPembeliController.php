<?php namespace App\Http\Controllers;
	...
	class AdminPembeliController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Jenis Kelamin","name"=>"jk","callback_php"=>'$row->jk == "L" ? "Laki-laki" : "Perempuan"'];
			...
			$this->form[] = ['label'=>'Username','name'=>'cms_users_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Alamat','name'=>'alamat','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Jenis Kelamin','name'=>'jk','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'L;P','datatable_where'=>'id_cms_privileges=2 and id not in (select cms_users_id from pembeli)'];
